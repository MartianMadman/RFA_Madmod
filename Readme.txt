...
\Changelog v0.9.4/
-Attempt to reduce severity of rl_d3d_light's exceeded error by slightly reducing medium light draw distances.
-Attempt to reduce severity of rl_d3d_light's exceeded error by disabling salvage highlights.
