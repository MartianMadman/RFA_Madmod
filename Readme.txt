...
\Changelog v0.9.4/
-Disable highlights for ammo boxes and salvage. Reduces amount of lights used which can improve performance.
...
-Increase vfx draw distances for default-specs.
